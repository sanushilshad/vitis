...
INSERT INTO setting(id, label, key, value_type,  is_deleted, created_on, created_by, is_editable, is_global, is_user, is_business, is_user_business, description) VALUES(uuid_generate_v4(), 'Business Invite Request template', 'business_invite_request_template', 'text', false, CURRENT_TIMESTAMP,  '00000000-0000-0000-0000-000000000000', true, true, false, false, false, null);
