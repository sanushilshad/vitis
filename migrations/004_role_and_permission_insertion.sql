...
INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'associate:user-business', 'User Business Association', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, true, false, false);
INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'list:users', 'list users', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, true, false, false, false);


INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'list:user-business', 'List User Business', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, true, false, false);
INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'list:user-business:self', 'List User Business Self', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, true, false, false);
INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'delete:business', 'Delete Business', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, true, false, false);



INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'create:leave-request:self', 'create leave request self', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, true, false, false);
INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'create:leave-request', 'create leave request', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, true, false, false);
INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'update:leave-request-status', 'update leave request status', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, true, false, false);
INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'approve:leave-request', 'approve leave request', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, true, false, false);
INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'list:leave-request', 'list leave requests', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, true, false, false);
INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'list:leave-request:self', 'list leave requests self', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, true, false, false);
INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'create:leave-type', 'create Leave Type', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, true, false, false);
INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'list:user-leave:self', 'List Leave', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, true, false, false);
INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'list:user-leave', 'List Leave Self', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, true, false, false);



INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'create:user-setting', 'create user setting', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, false, false, true);
INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'create:user-setting:self', 'create user setting self', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, false, false, true);
INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'create:business-setting:self', 'create business setting self', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, true, false, false);
INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'create:business-setting', 'create business setting', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, true, false, false);
INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'create:global-setting', 'create global setting', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, true, false, false, false);
INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'create:user-business-setting', 'create User-Business setting', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, true, false, false, false);
INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'send:business-invite', 'send business invite', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, true, false, false);
INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'update:business', 'update business', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, true, false, false);

INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'disassociate:user-business', 'disassociate business self', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, true, false, false);
INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'disassociate:user-business:self', 'disassociate business', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, true, false, false);

INSERT INTO permission(id, name, description, created_on, created_by, is_global, is_business, is_department, is_user)VALUES(uuid_generate_v4(), 'create:business-role', 'create business role', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid, false, true, false, false);
...
-- INSERT INTO permission(id, name, description, created_on, created_by)VALUES(uuid_generate_v4(), 'create:department', 'Create Department', CURRENT_TIMESTAMP, '00000000-0000-0000-0000-000000000000'::uuid);
